...
namespace LuxBotSharp
{
	public static class Utils
	{
		...
		public static System.Drawing.Point MousePosition
		{
			...
			set
			{
				Utils.MoveMouse(value, true, 100);
			}
		}
		...
		[DllImport("user32.dll")]
		[return: MarshalAs(UnmanagedType.Bool)]
		private static extern bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int X, int Y, int cx, int cy, Utils.SetWindowPosFlags uFlags);
